...
public class Graph_DFS_VS_BFS{
	...
	public static void main(String[] args) {
		...
		// 创建图对象
		Graph_DFS_VS_BFS graph_DFS_VS_BFS = new Graph_DFS_VS_BFS(n);
		// 循环添加顶点
		for(String vertex : Vertexs){
			graph_DFS_VS_BFS.insertVertexList(vertex);
		}
		// 添加边
		// A-B A-C B-C B-D B-E
		graph_DFS_VS_BFS.insertEdge(0, 1, 1); //1-2  -  表示A与B能相连
		graph_DFS_VS_BFS.insertEdge(0, 2, 1); 
		graph_DFS_VS_BFS.insertEdge(1, 3, 1); 
		graph_DFS_VS_BFS.insertEdge(1, 4, 1); 
		graph_DFS_VS_BFS.insertEdge(3, 7, 1);
		graph_DFS_VS_BFS.insertEdge(4, 7, 1); 
		graph_DFS_VS_BFS.insertEdge(2, 5, 1); 
		graph_DFS_VS_BFS.insertEdge(2, 6, 1); 
		graph_DFS_VS_BFS.insertEdge(5, 6, 1); 
		
		// 显示邻阶矩阵
		graph_DFS_VS_BFS.showGraph();
		
//		System.out.println(vertexList);
		
		System.out.println("图的深度优先遍历：");
		graph_DFS_VS_BFS.dfs();
		System.out.println();
		System.out.println("图的广度优先遍历：");
		graph_DFS_VS_BFS.bfs();
